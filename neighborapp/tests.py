...
class UserProfileTestClass(TestCase):
    # Set up method
    def setUp(self):
        self.user = User.objects.create_user(username='maureen', password='akinyi23')
        self.profile = UserProfile(id=1,first_name='maureen',last_name='Akinyi',user = self.user,bio='test bio')
